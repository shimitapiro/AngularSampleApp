 ...
 * Contains: Lightstreamer/LightstreamerClient, Lightstreamer/Subscription, Lightstreamer/BufferAppender, Lightstreamer/ConsoleAppender
 *   Lightstreamer/FunctionAppender, Lightstreamer/RemoteAppender, Lightstreamer/LogMessages
 * AMD
 */
(function (o) {
    o('infrastruct/libs/lightstreamer/lightstreamer', function () {
        return new Function();
    });
    var l = 'Lightstreamer/';
    var define = function (c, a, d) {
    ...
    define("Environment", ["IllegalStateException"], function (g) {
        var f = "undefined" !== typeof window && navigator && document,
            e = "undefined" !== typeof importScripts,
            b = "object" == typeof process && (/node(\.exe)?$/.test(process.execPath) || process.node && process.v8 || process.versions && process.versions.node && process.versions.v8);
    ...
    define("BrowserDetection", ["Environment"], function (g) {
        ...
        var a =
                g.isBrowser() ? null : !1,
            c = g.isBrowser() ? navigator.userAgent.toLowerCase() : null,
            l = a;
        g = {
        ...
        g.prototype = {
            ...
            remove: function (f) {
                for (var e = 0; e < this.data.length; e++)
                    if (this.data[e] == f) return this.data.splice(e, 1), !0;
                return !1
            },
            forEach: function (f) {
    ...
    define("EnvironmentStatus", ["Helpers", "BrowserDetection", "Environment", "List"], function (g, f, e, b) {
        ...
        q = {
            ...
            Gu: function () {
                ...
                if (!g.addEvent(window, "load", this.Yj)) this.ji();
        ...
        b.prototype = {
            ...
            PB: function () {
                ...
                try {
                    ...
                    return this.Vb(), new h("exception " + a + " " + c, 6, !1, !0)
                }
            },
            Zm: function (b, h, e) {
                var t = null;
                ...
                a: {
                    var t = "javascript:" + ('eval("' + d(b, b + "__TRASH") + '; ")'),
                        E = null;
            ...
            Hr: function (a, c, b) {
                try {
                    ...
                    if (!h.Lightstreamer) return k.logDebug(g.resolve(14)), !1;
    ...
    define("Executor", ["Helpers", "EnvironmentStatus", "Environment"], function (g, f, e) {
        ...
        var l = 50,
            ...
            t = null,
            s = 0,
            E = !e.isBrowserDocument() ||
                "http:" != document.location.protocol && "https:" != document.location.protocol ? "*" : document.location.protocol + "//" + document.location.hostname + (document.location.port ? ":" + document.location.port : ""),
            C = b,
            y = !1,
            x = {
                toString: function () {
    ...
    define("Inheritance", ["IllegalStateException"], function (g) {
        ...
        var e = {
            Tt: function (b, d, f, a) {
                for (var c in d.prototype)
                    if (!b.prototype[c]) b.prototype[c] = d.prototype[c];
                    else if (a) {
                        var l;
                        a: {
                            l = d.prototype;
            ...
            b = {
                ...
                readCookie: function (b) {
                    ...
                    for (var e = this.getAllCookiesAsSingleString(),
                             e = e.split(";"), a = 0; a < e.length; a++)
                        if (e[a] = g.trim(e[a]), 0 == e[a].indexOf(b)) return e[a].substring(b.length, e[a].length);
                    return null
                },
    ...
    define("lsAZ", ["lsA"], function (g) {
        ...
        return {
            ...
            il: function (e, b, d) {
                ...
                d = this.Wj(e);
                if (!d) d = "|";
                else if (-1 < d.indexOf("|" + b + "|")) return !1;
                this.write(e, d + (b + "|"));
                return !0
            },
            Ah: function (e, b, d) {
    ...
    define("IFrameHandler", ["BrowserDetection", "EnvironmentStatus", "Environment"], function (g, f, e) {
        var b = g.isProbablyAWebkit() && g.isProbablyChrome(32, !0) ? null : "about:blank",
            d = {},
            h = {
    ...
    define("lsAY", "Executor lsA lsAW lsAa lsAX Helpers EnvironmentStatus IFrameHandler LoggerManager lsG Environment".split(" "), function (g, f, e, b, d, h, a, c, l, n, k) {
        ...
        m.prototype = {
            ...
            cA: function () {
                if (this.xh) p.logDebug(l.resolve(23)), this.xh = !1;
                else {
                    var a = !1;
                    if (this.to) {
            ...
            Hy: function (a, c) {
                ...
                if (this.ph[a])
                    if (this.ph[a] != c) p.logInfo(l.resolve(21)), this.Li();
                    else return !1;
                this.ph[a] = c;
                return !0
            },
    ...
    define("lsAR", "lsF Executor LoggerManager BrowserDetection Inheritance CookieManager lsAY Helpers lsA lsG".split(" "), function (g, f, e, b, d, h, a, c, l, n) {
        ...
        k.prototype = {
            ...
            qA: function (a, c) {
                var l = null;
                if ((this.Eo || null == a) && this.fC) t.logDebug(e.resolve(31)), l = this.Sv(), this.Eo = !1;
                else if (null != a) t.logDebug(e.resolve(32)), this.nt(a), this.Eo = !0;
                else return 10 == this.ln && t.logDebug(e.resolve(33)), 10 >= this.ln && this.ln++,
                        null;
            ...
            xw: function () {
                ...
                for (var q = 0; q < k.length; q++) {
                    var r =
                            k[q] + "_" + this.appName,
                        s = d.Wf(this.appName, k[q]);
                    if (s)
                        if (this.Sf[s[l.dp]]) t.logDebug(e.resolve(47), r);
                        else if (s[l.Wo] != l.Vk || s[l.gp] != l.rg) t.logDebug(e.resolve(48), s);
                        else {
                            var n = c.getTimeStamp(),
                                g = n - parseInt(s[l.yc]),
                                p = 1E3 - g;
                            if (g > b) this.Vc[r] ? g > 2 * l.Td ? (this.Vc[r] = null, t.logDebug(e.resolve(49), r)) : (this.Vc[r] = s[l.yc], this.jg && f.executeTask(this.jg, [p]), t.logDebug(e.resolve(50), r)) : t.logDebug(e.resolve(51), r);
                            else {
                                if (this.ho)
                                    if (!this.Vc[r]) {
    ...
    define("lsH", ["LoggerManager", "lsG", "Inheritance", "Setter", "lsA"], function (g, f, e, b, d) {
        ...
        var a = g.getLoggerProxy(d.Uk),
            c = g.getLoggerProxy(d.Qa);
        h.prototype = {
            Zi: function (a) {
                return this.Ok[a]
            },
    ...
    define("ASSERT", ["LoggerManager"], function (g) {
        var f = g.getLoggerProxy("weswit.test"),
            e = 0,
            b = {},
            d = {
                VOID: b,
                ...
                compareArrays: function (b, a, c) {
                    ...
                    if (c)
                        ...
                        for (d = 0; d < a.length; d++)
                            if (c[a[d]]) c[a[d]]++;
                            else return f.logError(g.resolve(481), a[d]), this.Lb(), !1;
                        for (d in c)
                            if (1 ==
    ...
    define("lsq", "LoggerManager lsG lsB Environment ASSERT lsA".split(" "), function (g, f, e, b, d, h) {
        var a = g.getLoggerProxy(h.Re),
            c = e.ux(),
            l = /^[a-z][a-z0-9-]+$/,
            n = /^((?:[a-z][a-z.0-9-]+).(?:[a-z][a-z-]+))(?![\w.])/,
            k = /^((?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?).){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?))(?![d])/,
            m = /^[a-f0-9:]+$/;
        return {
            aC: function (a) {
                a = a.toLowerCase();
            ...
            qw: function (a) {
                return {
                    LS_op: "constrain",
                    LS_requested_max_bandwidth: 0 < a.Qc ? a.Qc : 0
                }
            },
            br: function (c, b, d) {
    ...
    define("lsK", "IllegalArgumentException lsH Inheritance Environment Global lsq lsG".split(" "), function (g, f, e, b, d, h, a) {
        ...
        var l = {
            ...
            k = !b.isBrowser() || "http:" != location.protocol && "https:" !=
    ...
    define("lsAV", "lsAQ Inheritance LoggerManager lsG Executor ASSERT lsA Helpers".split(" "), function (g, f, e, b, d, h, a, c) {
        ...
        l.prototype = {
            ...
            dz: function (a, c) {
                ...
                this.kd++;
                try {
                    this.tb = a, this.fb().Hs.S(n.newPage, -1, {
                        Po: window,
                        Pj: this.kd,
                        Jn: this.Jn
                    })
            ...
            zn: function (a, c, d) {
                a ? this.ag("updateSubscriptionParams", b.ba({
                    G: c
                }, d)) : this.ag("updateSubscriptionParams", b.ba({
                    Ie: c,
                    kb: this.p
                }, d))
            },
            Gj: function (a, c, d, h, l) {
                this.ag("onTable", b.ba({
                    yb: a,
                    Ie: c,
                    Cb: d,
                    kb: this.p,
            ...
            qs: function (a, c) {
                this.ag("tableRequestSubmission", {
                    kb: this.p,
                    G: a,
                    hf: c
                })
    ...
    define("lsAe", ["Executor", "LoggerManager", "ASSERT", "lsA"], function (g, f, e, b) {
        ...
        var h = f.getLoggerProxy(b.ug),
            a = f.getLoggerProxy(b.Qa);
        d.prototype = {
    ...
    define("lsD", ["LoggerManager", "Executor", "lsA"], function (g, f, e) {
        ...
        d.prototype = {
            ...
            hs: function (a, c, d, h) {
                if (this.Dg) this.N.push(new b(a, c, d, h)), this.Sa();
                else {
                    this.xh();
            ...
            handleEvent: function (a) {
                try {
                    if (this.ov.vi(a.pq, a.xs))
                        if (this.vq[a.fl]) this.vq[a.fl](a.Ae);
                        else h.logError(g.resolve(95))
                } catch (b) {
    ...
    define("lsp", "lso Inheritance lsF lsD lsL lsK lsJ LoggerManager lsA lsG".split(" "), function (g, f, e, b, d, h, a, c, l, n) {
        ...
        k.prototype = {
            ...
            Ub: function (a, b) {
                this.oa("endOfSnapshot", {
                    G: a,
                    item: b
                })
            },
            Tb: function (a, b) {
                this.oa("clearSnapshot", {
                    G: a,
                    item: b
                })
            },
            xe: function (a) {
                this.oa("messageDiscarded", {
                    Ga: a
                })
            },
            ks: function (a, b, c) {
                this.oa("messageDenied", {
                    Ga: a,
                    el: b,
                    Rc: c
                })
            ...
            js: function (a) {
                this.oa("messageComplete", {
                    Ga: a
                })
            },
            ls: function (a) {
                this.oa("messageOnNetwork", {
                    Ga: a
                })
            },
            rc: function (a) {
                this.bt("sessionReadyNotification", {
                    a: a
                }, a)
            },
            Tc: function (a) {
    ...
    define("lsn", "lsD EnvironmentStatus lsp lsk Executor lsG LoggerManager ASSERT lsg lsQ lsV lsA Helpers".split(" "), function (g, f, e, b, d, h, a, c, l, n, k, m, p) {
        ...
        q.prototype = {
            ...
            hr: function (b, d, h, e, l, k) {
                ...
                l = this.s[e];
                if (!l) r.logError(a.resolve(123), this, e), c.fail();
                else if (this.X.re()) {
                    var f;
    ...
    define("lsl", ["LoggerManager", "BrowserDetection", "Helpers", "lsA"], function (g, f, e, b) {
        var d = f.isProbablyFX(1.5, !0) ? 10 : 50,
            h = d,
            a = 0,
            c = 0,
            l = 0,
    ...
    define("lsa", ["lsAH", "lsO", "lsG"], function (g, f, e) {
        ...
        b.prototype = {
            ...
            qq: function (b, h, a) {
                for (a = a ? "" : "\r\n"; 0 < b.getLength() ;) {
                    var c = b.Ri(),
                        e = c.Ks,
                        g = c.Wd;
                    if (g == f.Qd && e.lh()) b.shift();
                    else if (g != f.Se || e.wu())
                        if (e && e.verifySuccess && e.verifySuccess()) b.shift();
                        else return b = c.Xc, g == f.Qe ? a + this.im(b,
                            e, h) : g == f.Oe ? a + this.fm(b, e, h) : g == f.Pe ? a + this.gm(b, e, h) : g == f.gd ? a + this.hm(b, e, h) : a + this.em(b, e, h);
                    else e.Bj(), b.shift()
                }
                return null
            },
            expand: function (b, e) {
                var a = "";
                if (b)
                    for (var c in b) c !== e && (a += c + "\x3d" + b[c] + "\x26");
                return a
            },
            Rg: function (b, e) {
                var a = this.expand(b);
    ...
    define("lsAK", "lsAI Inheritance EnvironmentStatus Executor Environment LoggerManager lsG ASSERT lsf lsA".split(" "), function (g, f, e, b, d, h, a, c, l, n) {
        ...
        var p = h.getLoggerProxy(n.ab),
            q = null;
        d.isNodeJS() && (q = a.Aj("faye-websocket").Client);
        var r = "js.lightstreamer.com",
            t = new l,
            s = !1;
        k.Wl = function () {
            s = !0
        ...
        k.prototype = {
            ...
            Hz: function (a, c, d, e, l) {
                if (this.k) p.logError(h.resolve(138));
                else if (s) return !1;
                this.ye = !1;
                this.Gh = a.cc;
                this.Xa = c;
    ...
    define("lsr", "EnvironmentStatus Helpers LoggerManager Executor lsl lsA lsR lsO lsq ASSERT BrowserDetection lsAK".split(" "), function (g, f, e, b, d, h, a, c, l, n, k) {
        ...
        var p = e.getLoggerProxy(h.Ud),
            q = e.getLoggerProxy(h.Re);
        m.dl = 1;
        m.Rd = 2;
        m.$o = 3;
        m.bp = 4;
        ...
        m.prototype = {
            ...
            Xw: function () {
                ...
                var a = this.c.Dd;
                if (this.Ge) var b = f.getTimeStamp() - this.Ge,
                    a = a > b ? a - b : 0;
                return a
            },
            Nu: function () {
                this.Ge || (p.logError(e.resolve(164), this), n.fail(), this.Fd = null);
                var a = f.getTimeStamp() - this.Ge,
                    b = this.c.bf;
                this.Fd = (a > b ? b : a) + b
            },
            yz: function (a,
        ...
        k.prototype = {
            ...
            ra: function (a, b, d, l, k) {
                ...
                try {
                    ...
                    var f = a.yq;
                    if (f)
                        for (var g in f) this.W.setRequestHeader(g, f[g]);
    ...
    define("lsE", ["Executor", "IFrameHandler", "Global", "BrowserDetection", "lsG"], function (g, f, e, b, d) {
        function h(b) {
            ...
            try {
                this.lc = f.getFrameWindow(b, !0, h), this.Ey() ? g.addTimedTask(this.am, 1, this) : this.zj() || this.am()
            } catch (n) { }
        }
        var a = 0;
        h.prototype = {
    ...
    define("lss", "lsA Inheritance lsr lsz lsAD lsAH lsG lsq Executor LoggerManager BrowserDetection EnvironmentStatus lsAE lsAN".split(" "), function (g, f, e, b, d, h, a, c, l, n, k, m, p, q) {
        ...
        var s = {
            ...
            C = 1,
            y = 1,
            x = n.getLoggerProxy(g.Ud),
            w = n.getLoggerProxy(g.Re);
        r.prototype = {
            Xf: function (a) {
                a = a || !this.c.Ai;
            ...
            fg: function (a) {
                this._callSuperMethod(r, s.shutdown, [a]);
                this.We && this.We.$()
            },
            Ug: function (a, b, d) {
                var l = this.a == e.dl || this.a == e.bl,
                    f = this.Oc(),
                    f = new h(f + g.Zk);
                f.Hh(this.c.Qb());
                f.Jh(this.c.sf());
            ...
            wq: function (a, d, f) {
                ...
                (s.Bc(), this.ta = null);
                for (var q = !1, m = (this.K ? "LS6__POLLFRAME" : "LS6__PUSHFRAME") + "_" + this.Jb;
                     (this.ta || s.Im()) && !1 === q;) {
                    if (!this.ta) {
    ...
    define("lsu", "lsA lsr lss Inheritance lsAK lsz lsq Executor LoggerManager ASSERT lsAH lsG".split(" "), function (g, f, e, b, d, h, a, c, l, n, k, m) {
        ...
        var q = {
            ...
            q = m.getReverse(q),
            r = l.getLoggerProxy(g.Ud);
        p.prototype = {
            toString: function () {
                return ["[|SessionWS",
                    this.K, this.je, this.a, this.na, this.Na, this.Zb, this.ng, this.pb, this.U, this.cd, this.ad, "]"
                ].join("|")
            },
            ae: G("Zb"),
            Pq: function () {
            ...
            Bn: function () {
                ...
                a.Hh(this.c.Qb());
                a.Jh(this.c.sf());
                if (h.uf(d, a.xa(), this.c.Qb(), a.wa(), this.c.eh()) && (r.logDebug(l.resolve(242)), this.U.Hz(a, this.Rf, this.vl, this.ul, this.tl))) return this.Q.ll(this.U), this.ae(2), !0;
                this.ae(5);
                return !1
            },
            Tl: function () {
            ...
            li: function (b, e) {
                if (b == this.na)
                    if (this.nf = !1, 1 == this.Zb ? this.Bn() : 2 != this.Zb || this.U.Nx(this.Oc()) || (r.logWarn(l.resolve(240)), this.U.$(), this.ae(1), this.Bn()), 6 == this.Zb) this.Uc(this.J, "ws.early.closed");
                    else if (5 == this.Zb) this.Uc(this.J, "ws.notgood");
                    else if (3 == this.Zb) d.Wl(), this.Uc(this.J, "ws.early.openfail");
                    else {
                        var h = this.Ug(null, e, !1),
                            f = !1;
            ...
            Cd: function (a, b) {
                a == this.na && (this.a == f.Rd && (this.nf = !0), this._callSuperMethod(p, q.onTimeout, [a, b]))
            },
            on: function (a) {
    ...
    define("lsm", ["Global", "LoggerManager", "EnvironmentStatus", "ASSERT", "lsA"], function (g, f, e, b, d) {
        ...
        h.prototype = {
            ...
            qz: function (a, b, c, d, e, h, f, g) {
                if (this.sc(b, null, 1 == a, 3 == a || 4 == a))
                    if (1 == a) this.g.nz(c, d, h, e, f, g);
                    else if (2 == a) this.g.kz(c);
                    else if (3 == a) this.g.Bz();
                    else if (4 == a) {
                        a = 30;
                        if (null != c) {
                            a = c;
            ...
            lz: function (c, d, e, h) {
                if (this.sc())
                    if (b.verifyValue(e.substring(0, 3), "MSG") || a.logError(f.resolve(249), e), e = e.substr(3), 39 == c)
                        for (c = parseInt(h), d = parseInt(d), c = d - c + 1; c <= d; c++) this.g.xe(e, c);
                    else 38 == c ? this.g.xe(e, d) : 0 >= c ? this.g.qn(e, c, h, d) : this.g.Nf(e, c, h, d)
            },
            za: function (a, b, c, d) {
            ...
            $y: function (b, c, d, e, h, g, r) {
                if (this.sc(null, 4 == b || 5 == b || 9 == b ? null : c))
                    if (4 == b) this.g.pn(d, c);
                    else if (5 == b) this.g.rn(d, c);
                    else if (8 == b) this.g.onUnsubscription(d);
                    else if (6 == b) this.g.onSubscription(d, e, h, g + 1, r + 1);
                    else 9 == b ? this.g.Pf(d, c) : a.logDebug(f.resolve(252), b)
            }
        };
        return h
    });
    ...
    define("lsv", ["LoggerManager", "Global", "Helpers", "ASSERT", "lsA"], function (g, f, e, b, d) {
        ...
        var a = g.getLoggerProxy(d.Re),
            c = g.getLoggerProxy(d.Ud);
        h.prototype = {
            toString: function () {
        ...
        d.prototype = {
            ...
            gA: function (a) {
                ...
                for (var b = 0; b < this.Bb.length; b++)
                    if (this.Bb[b] == a) return this.Nn(b)
            },
            shift: function () {
                return this.Nn(0)
            },
    ...
    define("lsN", "lsO lsP LoggerManager lsAH Executor lsz lsA ASSERT".split(" "), function (g, f, e, b, d, h, a, c) {
        ...
        n.prototype = {
            ...
            eq: function (a, b) {
                if (a == this.f) {
                    for (var c = 0; 1 > c;) {
                        ...
                        if (1 == d) k.logInfo(e.resolve(284)), this.o = null;
                        else {
                            if (2 == d) {
                            ...
                            if (5 == d) k.logInfo(e.resolve(287)), this.ga(3), this.o.nn(), this.o = null, this.ga(1);
                            else {
            ...
            Ys: function (h) {
                ...
                for (; this.Ka || this.kc.Im() ;) {
                    ...
                    if (!1 === g) k.logDebug(e.resolve(308)), this.Ka = null;
                    else {
            ...
            bq: function (a, b) {
                var c = b.le();
                if (null == this.o) this.o = new l, this.o.it(c), this.o.fill(a, this.Bh, this.sa.bh(), this.c.Qb(), this.c.sf());
                else if (this.o.Fy(c) && (this.o.it(c), c = this.o.bA(this.Bh,
                    this.sa.bh(), this.c.Qb(), this.c.sf())))
                    for (var d = c.sd() ; 0 < c.getLength() ;) this.tp(d, c.shift());
        ...
        l.prototype = {
            ...
            it: G("Ic"),
            fill: function (a, b, c, d, h) {
                if (!(0 >= a.getLength()))
                    if (this.Da = new f(a.sd()), this.Xc = this.Ic.Hx(a, d, h), d = "", h = this.Ic.qq(a, c, !0), null === h) this.Xc = this.Da = null;
                    else {
                        var l = this.Ic.vm(this.Xc.getFile()),
                            g = this.Ic.ym(h) + h.length;
        ...
        h.prototype = {
            ...
            lp: function (b, d) {
                this.hg() && (this.ub.push({
                    Jj: b,
                    sb: d
                }), a.isDebugLogEnabled() && a.logDebug(g.resolve(326)),
    ...
    define("lsw", "LoggerManager Executor lsE Inheritance Global lsh lsA".split(" "), function (g, f, e, b, d, h, a) {
        ...
        c.prototype = {
            ...
            Ei: function () {
                if (this.mb)
                    for (l.isDebugLogEnabled() && l.logDebug(g.resolve(331)) ; 0 < this.ub.length;) {
                        var a = this.ub.shift();
                        if (this.e && this.e.ha(a.Jj)) {
                            var b = null,
                                c = null;
                            if (!this.Ii.wd() && (-1 < (b = a.sb.indexOf("// END OF HEADER")) || -1 < (c = a.sb.indexOf("myEnv.LS_window \x3d LS_window;")))) {
                                var d; -1 < b ? (d = a.sb.substring(0, b), b = a.sb.substring(b)) : (d = a.sb.substring(0, c + 28), b = a.sb.substring(c + 28));
                                a.sb = b;
                                this.Ii.Lv(d)
                            }
                            try {
    ...
    define("lst", "Executor BrowserDetection ASSERT LoggerManager Helpers lsq lsl lsAK lss lsu EnvironmentStatus Global lsm lsO lsU lsA lsv lsN lsT lsi lsw".split(" "), function (g, f, e, b, d, h, a, c, l, n, k, m, p, q, r, t, s, E, C, y, x) {
        ...
        T[I] = !0;
        T[F] = !0;
        var B = b.getLoggerProxy(t.Re),
            O = b.getLoggerProxy(t.Ud);
        w.prototype = {
            Mv: function () {
                var a = this;
        ...
        d.prototype = {
            ...
            addListener: function (b) {
                b && (b = {
                    d: b,
                    Ir: !0
                }, this.Gk.add(b), this.Xl("onListenStart", [this], b, !0))
            },
        ...
        b.prototype = {
            remove: function (b) {
                for (var a = 0; a < this.data.length; a++)
                    if (this.data[a].d == b) return b = this.data[a], b.Ir = !1, this.data.splice(a, 1), b;
                return !1
            },
            asArray: function () {
                var b = [];
    ...
    define("lsAP", "Executor lsA LoggerManager Inheritance Setter Environment IllegalStateException IllegalArgumentException Helpers".split(" "), function (g, f, e, b, d, h, a, c, l) {
        ...
        n.prototype = {
            ...
            Ej: function (a, b) {
                "CREATE" == this.eg ? (r.logInfo(e.resolve(401)), this.R.jq(this.T, b || this.Uf)) : "WAIT" == this.eg ? (r.logInfo(e.resolve(402), 1E3), g.addTimedTask(this.cC, 1E3, this, [a])) : (r.logInfo(e.resolve(403)), this.R.$l())
            },
            cz: function () {
    ...
    define("LightstreamerClient", "Helpers Global lsAR Executor CookieManager lsAY lsJ lsL lsK lsAV lsAT lsAU lsAe lsD lsj lsAS Inheritance Setter EventDispatcher lsA EnvironmentStatus IllegalArgumentException Environment LoggerManager lsAP IllegalStateException ASSERT lsm".split(" "), function (g, f, e, b, d, h, a, c, l, n, k, m, p, q, r, t, s, E, C, y, x,
        ...
        var A = z.getLoggerProxy(y.Qa),
            F = z.getLoggerProxy(y.Uk),
            R = 0,
            L = /^[a-zA-Z0-9_]*$/;
        ...
        v.prototype = {
            ...
            jq: function (a, b) {
                ...
                var c = new r(a, this.M, this.fa, this.qa, this.dc.Hu()),
                    c = new k(this, c);
                this.kl(c);
                c.bound(!0)
            },
            ...
            iy: function (a, b) {
                ...
                for (var k = 0; k < l.length; k++) {
                    var n = f.Wf(a, l[k]);
                    if (!n || 5 > n.length) I(l[k], a);
                    else if (b && b[l[k]]) {
                        if (n[y.yc] != b[l[k]]) return A.logInfo(z.resolve(412)), !0;
                        A.logInfo(z.resolve(413))
                    } else {
                        var p = Number(n[y.yc]) + y.Td + 2E3 - e; -6E4 >= p ? (A.logInfo(z.resolve(414)), I(l[k], a)) : (p < this.dn && (p = this.dn), c[l[k]] = n[y.yc], d = !0, c.hi = c.hi > p ? c.hi : p)
                    }
                }
            ...
            sendMessage: function (a, c, d, e) {
                if (!c) c = y.zc;
                else if (!L.test(c)) throw new w("The given sequence name is not valid, use only alphanumeric characters plus underscore, or null");
    ...
    define("Subscription", "lsAc lsAb lsY lsZ Inheritance Setter Matrix Executor lsA EventDispatcher IllegalArgumentException IllegalStateException LoggerManager lsG ASSERT Helpers".split(" "), function (g, f, e, b, d, h, a, c, l, n, k, m, p, q, r, t) {
        ...
        var y = {
            ...
            x = l.vg,
            w = p.getLoggerProxy(l.ug),
            K = " name cannot be empty",
            z = " name cannot contain spaces",
            P = " name cannot be a number";
        s.prototype = {
            toString: function () {
                return ["[|Subscription", this.Za, this.Ek,
                    this.bc, this.Cb, this.yb, "]"
                ].join("|")
            },
            Np: function () {
                this.Je = null;
            ...
            Lh: function (a) {
                ...
                if (a || 0 == a)
                    if ("unfiltered" == a || "unlimited" == a) this.Ya = a;
                    else try {
                ...
                if ((this.Sm() || this.Qm() || this.qe()) && String(b) != String(this.Ya) && (this.Ug(), this.d.fd(this,
                    ...
                    for (var d in this.Aa)
                        for (var e in this.Aa[d]) r.verifyOk(this.qe()), this.Aa[d][e].Lh(this.Ya);
            ...
            sk: function (a) {
                this.zb();
                if (a || 0 == a)
                    if (a = new String(a), a = a.toLowerCase(), "unlimited" == a) this.De = a;
                    else try {
            ...
            bo: function (a) {
                this.zb();
                if (a || 0 == a)
                    if (a = new String(a), a = a.toLowerCase(), "no" == a) this.nc = a;
                    else {
            ...
            Jz: function (a, b, c) {
                ...
                if (c) a[this.keyCode + 1] = x, a[this.eb + 1] == this.Sc.get(d, this.eb) ? a[this.eb + 1] = x : (a.Gc.push(this.eb), a.Gc.sort(C));
                else {
                    a.Gc = [];
                    for (c = 2; c < a.length; c++) a[c] && a[c] == x ? a[c] = this.we.get(b, c - 1) : this.we.insert(a[c], b, c - 1), a[c] == this.Sc.get(d, c - 1) ? a[c] = x : a.Gc.push(c - 1);
                    if (3 == this.rb && (b = this.Xq() + 2, b > a.length))
                        for (c = a.length; c < b; c++) a[c] = x
                }
                return d
            },
            zx: function (a) {
    ...
    define("RemoteAppender", ["Inheritance", "BufferAppender", "Executor", "IllegalArgumentException", "SimpleLogLevels"], function (g, f, e, b) {
        ...
        d.prototype = {
            ...
            Ov: function (b, a) {
                var c = this._callSuperMethod(d, "extractLog", ["LS_log"]),
                    c = c.split("LS_log");
                a = "LS_log";
